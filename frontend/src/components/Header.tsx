...
import { Document, saveDocument } from '../redux/documentSlice'; 
    ...
    <header
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex flex-col">
          ...
          <span className="font-roboto font-bold text-lg text-white">{currentDocument.name}</span>
        </div>
      </div>
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center p-2">
          <button className="save-button flex items-center px-5 py-4 rounded-md" onClick={handleSaveChanges}>
